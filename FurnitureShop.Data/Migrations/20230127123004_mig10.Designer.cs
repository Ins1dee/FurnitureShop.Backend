...
namespace FurnitureShop.Data.Migrations
{
    ...
    [Migration("20230127123004_mig10")]
    partial class mig10
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FurnitureStorage.Data.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FurnitureStorage.Data.Entities.RefreshToken", b =>
                {
                    b.HasOne("FurnitureStorage.Data.Entities.User", "User")
                        .WithOne("RefreshToken")
                        .HasForeignKey("FurnitureStorage.Data.Entities.RefreshToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
